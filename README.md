...
- [3.使用方法](#3.使用方法)
  - [3.1 服务提供者](#3.1 服务提供者)
    - [3.1.1 安装 NuGet 包](#3.1.1 安装 NuGet 包)
    - [3.1.2 项目模块配置](#3.1.2 项目模块配置)
    - [3.1.3 健康检查配置【可选】](#3.1.3 健康检查配置【可选】)
    - [3.1.4 定义提供的服务接口](#3.1.4 定义提供的服务接口)
    - [3.1.5 实现提供的服务接口](#3.1.5 实现提供的服务接口)
    - [3.1.6 注意事项](#3.1.6 注意事项)
  - [3.2 服务调用者](#3.2 服务调用者)
    - [3.2.1 安装 NuGet 包](#3.2.1 安装 NuGet 包)
    - [3.2.2 项目模块配置](#3.2.2 项目模块配置)
    - [3.2.3 引用服务提供者的接口](#3.2.3 引用服务提供者的接口)
    - [3.2.4 调用接口](#3.2.4 调用接口)
- [4.DEMO 地址](#4.DEMO 地址)
